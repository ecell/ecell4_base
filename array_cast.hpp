...
{
    struct cannot_deduce_element_type_from_the_specified_type;
    enum { _ = sizeof(cannot_deduce_element_type_from_the_specified_type) };
};
...
template< typename T_ >
T_& array_cast( typename detail::element_type_of< T_ >::type* elts )
{
    return *elts;
}
...
T_& array_cast( Tx_& elts )
{
    BOOST_STATIC_ASSERT(( boost::is_same<
        typename boost::remove_const<
            typename detail::element_type_of< T_ >::type >::type,
