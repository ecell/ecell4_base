...
class BDPropagator(object):
    ...
    def fire_reaction1(self, pid_particle_pair, rt):
        ...
        if len(rt.products) == 0:
            ...
            self.reactions_occurred.append(Reaction(rt, [pid_particle_pair], []))
            ...
            self.reactions_occurred.append(Reaction(rt, [pid_particle_pair], [newparticle]))
    ...
    def fire_reaction2(self, pid_particle_pair1, pid_particle_pair2, rt):
        if len(rt.products) == 1:
            ...
            self.reactions_occurred.append(Reaction(
...
class BDSimulatorCoreBase(object):
    ...
    def step(self):
        ...
        self.reaction_events += len(ppg.reactions_occurred)
        self.t += self.dt
