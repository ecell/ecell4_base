#ifndef BINDING_CUBOIDAL_REGION_HPP
#define BINDING_CUBOIDAL_REGION_HPP
...
inline boost::python::objects::class_base register_cuboidal_region_class(char const *name)
{
