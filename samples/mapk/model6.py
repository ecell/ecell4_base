...
r3 = UnimolecularReactionType( K_KK, Kp_KK, k3 )
s.addReactionType( r3 )
r4 = UnbindingReactionType( Kp_KK, Kpp, KK, k6 )
s.addReactionType( r4 )


r5 = BindingReactionType( Kpp, P, Kpp_P, k1 )
s.addReactionType( r5 )
r6 = UnbindingReactionType( Kpp_P, Kpp, P, k2 )
s.addReactionType( r6 )
r7 = UnimolecularReactionType( Kpp_P, Kp_P,k3 )
s.addReactionType( r7 )
r8 = UnbindingReactionType( Kp_P, K, P, k6 )
