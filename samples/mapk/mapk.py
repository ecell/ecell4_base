...
r1 = BindingReactionRule( Ea, X, EaX, 1e9 / N_A )
s.addReactionRule( r1 )
r2 = UnbindingReactionRule( EaX, Ea, X, 1e3 )
s.addReactionRule( r2 )
r3 = UnbindingReactionRule( EaX, Ea, Xp, 1e3 )
s.addReactionRule( r3 )
r4 = BindingReactionRule( Ea, Xp, EaXp, 1e9 / N_A )
s.addReactionRule( r4 )
r5 = UnbindingReactionRule( EaXp, Ea, Xp, 1e3 )
s.addReactionRule( r5 )
r6 = UnbindingReactionRule( EaXp, Ea, Xpp, 1e3 )
s.addReactionRule( r6 )
r7 = BindingReactionRule( Ea, Xpp, EaXpp, 1e9 / N_A )
s.addReactionRule( r7 )
r8 = UnbindingReactionRule( EaXpp, EaI, Xpp, 1e3 )
s.addReactionRule( r8 )
r9 = UnimolecularReactionRule( EaI, Ea, 1e2 )
