...
r3 = UnbindingReactionRule( K_KK, Kp, KK, 1.5 )
...
r6 = UnbindingReactionRule( Kp_KK, Kpp, KK, 15.0 )
...
r9 = UnbindingReactionRule( Kpp_P, Kp, P, 1.5 )
...
r12 = UnbindingReactionRule( Kp_P, K, P, 15.0 )
