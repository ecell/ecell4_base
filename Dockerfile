...
ADD . /usr/src/ecell4
RUN cd /usr/src/ecell4; cmake .; make BesselTables; cd python; python setup.py build_ext; python setup.py bdist_wheel

#; pip install dist/ecell-4.0.0-cp27-none-linux_x86_64.whl
