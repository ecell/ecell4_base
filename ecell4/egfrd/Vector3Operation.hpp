...
template<typename coordT>
coordT rotation(const typename scalar_type_helper<coordT>::type angle,
...
template<typename coordT>
typename scalar_type_helper<coordT>::type
...
bool is_same_vec(const coordT& lhs, const coordT& rhs,
         const typename scalar_type_helper<coordT>::type tol = 1e-10)
{
