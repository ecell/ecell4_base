#if !defined( EGFRD_FIRSTPASSAGENOCOLLISIONPAIRGREENSFUNCTION )
#define EGFRD_FIRSTPASSAGENOCOLLISIONPAIRGREENSFUNCTION 
...
#endif // EGFRD_FIRSTPASSAGEPAIRGREENSFUNCTION 
