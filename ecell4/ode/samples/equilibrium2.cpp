...
int main(int argc, char** argv)
{
    ...
    rr1.add_product(sp2);
    rr1.add_product(sp3);
    boost::shared_ptr<Ratelow> ratelow1(
            new RatelowMassAction(ka, rr1.reactants().size()));
    ...
    rr2.add_product(sp1);
    boost::shared_ptr<Ratelow> ratelow2(
            new RatelowMassAction(kd, rr2.reactants().size()));
    rr2.set_ratelow(ratelow1);
