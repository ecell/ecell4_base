...
BOOST_AUTO_TEST_CASE(Shape_test_is_inside)
{
    ...
    BOOST_CHECK(sphere.is_inside(Position3(2.3e-6, 2.5e-6, 2.5e-6)));
    BOOST_CHECK(sphere.is_inside(Position3(2.5e-6, 2.3e-6, 2.5e-6)));
    BOOST_CHECK(sphere.is_inside(Position3(2.5e-6, 2.5e-6, 2.3e-6)));
    BOOST_CHECK(!sphere.is_inside(Position3(2.2e-6, 2.5e-6, 2.5e-6)));
    BOOST_CHECK(!sphere.is_inside(Position3(2.5e-6, 2.2e-6, 2.5e-6)));
    BOOST_CHECK(!sphere.is_inside(Position3(2.5e-6, 2.5e-6, 2.2e-6)));
}
