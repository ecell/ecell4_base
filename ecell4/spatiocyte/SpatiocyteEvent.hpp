...
protected:
    ...
    void walk_in_space_(boost::shared_ptr<const MoleculePool> mtype, const Real& alpha);
    void walk_on_surface_(boost::shared_ptr<const MoleculePool> mtype, const Real& alpha);
