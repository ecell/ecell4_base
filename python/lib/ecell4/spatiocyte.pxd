...
cdef extern from "ecell4/spatiocyte/SpatiocyteWorld.hpp" namespace "ecell4::spatiocyte":
    cdef cppclass Cpp_SpatiocyteWorld "ecell4::spatiocyte::SpatiocyteWorld":
        ...
        pair[Cpp_ParticleID, Cpp_Voxel] get_voxel_private_private(Cpp_ParticleID& pid)
        # pair[Cpp_ParticleID, Cpp_Voxel] get_voxel(Integer)
        pair[Cpp_ParticleID, Cpp_Voxel] get_voxel_private_private(Integer)
        ...
        pair[pair[Cpp_ParticleID, Cpp_Voxel], bool] new_voxel_private_private(Cpp_Voxel& p)
        pair[pair[Cpp_ParticleID, Cpp_Voxel], bool] new_voxel_private_private(Cpp_Species& sp, Integer pos)
        pair[pair[Cpp_ParticleID, Cpp_Voxel], bool] new_voxel_structure_private_private(Cpp_Species& sp, Integer pos)
        ...
        vector[pair[Cpp_ParticleID, Cpp_Voxel]] list_voxels_private()
        vector[pair[Cpp_ParticleID, Cpp_Voxel]] list_voxels_private(Cpp_Species& sp)
        vector[pair[Cpp_ParticleID, Cpp_Voxel]] list_voxels_exact_private(Cpp_Species& sp)
        # bool update_voxel(Cpp_ParticleID, Cpp_Voxel)
        bool update_voxel_private(Cpp_ParticleID, Cpp_Voxel)
        ...
        pair[pair[Cpp_ParticleID, Cpp_Voxel], bool] new_voxel_interface_private_private(Cpp_Species& sp, Integer pos)
