...
from utils import INF, distanceSq_Simple, distance_Simple, distanceSqArray_Simple, distanceArray_Simple, distanceSq_Cyclic, distanceSqArray_Cyclic, distance_Cyclic
#from surface import *
#from _gfrd import *
...
cdef __Particle_eq( self, other ):
    return self.species == other.species and self.serial == other.serial

cdef class Particle:
    cdef public species
    cdef public int serial
    cdef public long hash

    def __cinit__( self, species, serial=None, index=None ):
    ...
    def __richcmp__( self, other, int op ):
        if op == 2:
            return __Particle_eq( self, other )
        elif op == 3:
            return not __Particle_eq( self, other )
        elif op == 0:
