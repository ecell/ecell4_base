...
all: 
	...
	g++ $(CXXFLAGS) -fPIC -c FirstPassageGreensFunction.cpp
	g++ $(CXXFLAGS) -fPIC -I. -I/usr/include/python2.4 -I$(NUMPYINCLUDE) -c pyGFRD.cpp 
	g++ $(CXXFLAGS) -shared -fPIC PlainPairGreensFunction.o FirstPassageGreensFunction.o pyGFRD.o -lboost_python -lgsl -lgslcblas -lm -o _gfrd.so
