...
data_V = numpy.array([\
        ...
        [1065.10697317,1065,1065],
        ])

Nc = numpy.array([30,100,300,1000,3000,10000,30000,100000])
#constant C
data_C = numpy.array([\
...
for i in range( len(Nv) ):
    plot_data( Nv[i], data_V[i],'k+' )
loglog( X, 0.3* X**(5.0/3), 'k--' )

for i in range( len(Nc) ):
    plot_data( Nc[i], data_C[i],'k+' )
loglog( X, 60* X, 'k-' )
...
for i in range( len(Cx3000) ):
    plot_data( Cx3000[i], data_N3000[i],'k+' )
loglog( Cx3000, 5e6** Cx3000, 'b:' )

for i in range( len(Cx300) ):
    plot_data( Cx300[i], data_N300[i],'k+' )

loglog( Cx300, 5e6** Cx300, 'b:' )
xlabel( 'Concentration [M]' )
ylabel( 'time [sec]' )
