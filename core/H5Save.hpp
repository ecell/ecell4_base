#ifndef __ECELL4_H5SAVE_HPP
#define __ECELL4_H5SAVE_HPP
...
public:
    ...
    void save(void)
    {
        ...
        boost::scoped_array<species_num_struct<MoleculesNumType> >
            species_num_table(
                new species_num_struct<MoleculesNumType>[species_list.size()]);
        ...
        boost::scoped_ptr<Group>
            parent_group(new Group(this->file_->openGroup(this->group_root_)));
