...
inline typename element_type_of< T1_ >::type distance_sq(
...
inline T1_ normalize( T1_ const& p, 
                      typename element_type_of< T1_ >::type const& r )
{
...
inline T_ cyclic_transpose(T_ const& p0, T_ const& p1, T_ const& world_size, typename boost::enable_if<boost::is_arithmetic<T_> >::type*)
{
...
template<typename T_>
inline T_ apply_boundary(T_ const& p1, T_ const& world_size, typename boost::enable_if<boost::is_arithmetic<T_> >::type*)
{
